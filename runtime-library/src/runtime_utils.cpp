...
ONNXTensorElementDataType map_to_ort_type(TensorElementType t) {
  switch (t) {
    ...
    case DATA_TYPE_STRING:         return ONNX_TENSOR_ELEMENT_DATA_TYPE_STRING;
    ...
    case DATA_TYPE_COMPLEX64:      return ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX64;
    case DATA_TYPE_COMPLEX128:     return ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX128;
    case DATA_TYPE_BFLOAT16:       return ONNX_TENSOR_ELEMENT_DATA_TYPE_BFLOAT16;
    case DATA_TYPE_FLOAT8E4M3FN:   return ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FN;
    case DATA_TYPE_FLOAT8E4M3FNUZ: return ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FNUZ;
    case DATA_TYPE_FLOAT8E5M2:     return ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2;
    case DATA_TYPE_FLOAT8E5M2FNUZ: return ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2FNUZ;
    default:
...
TensorElementType map_from_ort_type(ONNXTensorElementDataType type) {
  switch (type) {
    ...
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_STRING:         return DATA_TYPE_STRING;
    ...
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX64:      return DATA_TYPE_COMPLEX64;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX128:     return DATA_TYPE_COMPLEX128;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_BFLOAT16:       return DATA_TYPE_BFLOAT16;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FN:   return DATA_TYPE_FLOAT8E4M3FN;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FNUZ: return DATA_TYPE_FLOAT8E4M3FNUZ;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2:     return DATA_TYPE_FLOAT8E5M2;
    case ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2FNUZ: return DATA_TYPE_FLOAT8E5M2FNUZ;
    default:
      throw std::runtime_error("Unsupported ORT element type: " +
...
size_t get_element_byte_size(TensorElementType t) {
  switch (t) {
    ...
    case DATA_TYPE_FLOAT8E4M3FN:   return 1;
    case DATA_TYPE_FLOAT8E4M3FNUZ: return 1;
    case DATA_TYPE_FLOAT8E5M2:     return 1;
    case DATA_TYPE_FLOAT8E5M2FNUZ: return 1;
    default:                       return 0;
  }
}
