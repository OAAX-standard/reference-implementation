...
Tracks inference performance across runtime versions. **vs baseline** = `current / db223e77` throughput ratio; values > 1.0x are improvements.
...
| yolo11n | 640×640 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 106.3 | 110.4 | 46.45 | **+1.20x** |
| yolo11n | 640×640 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 105.1 | 107.2 | 47.08 | **+1.21x** |
| yolo11n_320 | 320×320 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 33.2 | 35.6 | 146.6 | baseline |
| yolo11n_320 | 320×320 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 28.4 | 30.6 | 173.6 | **+1.18x** |
| yolo11n_320 | 320×320 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 27.9 | 29.0 | 176.6 | **+1.20x** |
| yolo11s | 640×640 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 343.5 | 387.4 | 14.25 | baseline |
| yolo11s | 640×640 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 268.3 | 278.3 | 18.46 | **+1.30x** |
| yolo11s | 640×640 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 224.3 | 231.1 | 22.10 | **+1.55x** |
| yolo11s_320 | 320×320 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 79.0 | 85.1 | 61.81 | baseline |
| yolo11s_320 | 320×320 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 71.8 | 75.1 | 68.97 | **+1.12x** |
| yolo11s_320 | 320×320 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 67.1 | 69.0 | 73.77 | **+1.19x** |
| yolov8n | 640×640 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 110.0 | 113.1 | 44.93 | baseline |
| yolov8n | 640×640 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 113.8 | 117.4 | 43.50 | 0.97x |
...
| yolo11n_b4 | 640×640 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 521.1 | 541.2 | 37.95 | **+1.21x** |
| yolo11n_b4 | 640×640 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 457.7 | 470.1 | 43.18 | **+1.38x** |
| yolo11n_320_b4 | 320×320 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 121.4 | 128.5 | 160.3 | baseline |
| yolo11n_320_b4 | 320×320 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 98.9 | 103.7 | 199.3 | **+1.24x** |
| yolo11n_320_b4 | 320×320 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 93.4 | 97.4 | 211.6 | **+1.32x** |
| yolo11s_b4 | 640×640 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 1655.7 | 1823.2 | 11.81 | baseline |
| yolo11s_b4 | 640×640 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 1343.8 | 1381.0 | 14.75 | **+1.25x** |
| yolo11s_b4 | 640×640 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 1130.5 | 1149.8 | 17.53 | **+1.48x** |
| yolo11s_320_b4 | 320×320 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 343.0 | 395.6 | 57.05 | baseline |
| yolo11s_320_b4 | 320×320 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 277.6 | 285.1 | 71.40 | **+1.25x** |
| yolo11s_320_b4 | 320×320 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 212.0 | 217.4 | 93.54 | **+1.64x** |
...
| mobilenetv2 | 224×224 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 49.4 | 51.4 | 100.32 | **+1.11x** |
| mobilenetv2 | 224×224 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 81.4 | 83.3 | 60.90 | 0.68x ⚠️ |
| resnet18 | 224×224 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 65.3 | 85.2 | 74.73 | baseline |
| resnet18 | 224×224 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 52.4 | 53.7 | 94.50 | **+1.26x** |
| resnet18 | 224×224 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 56.4 | 58.2 | 87.80 | **+1.17x** |
| squeezenet | 224×224 | 2026-06-08 | db223e77 | n/a (4 threads) | 100 | 12.0 | 12.8 | 402.8 | baseline |
| squeezenet | 224×224 | 2026-06-08 | 6650641d | eco (intra=5 inter=2) | 300 | 11.5 | 11.8 | 426.9 | **+1.06x** |
| squeezenet | 224×224 | 2026-06-08 | 6650641d | power (intra=12 inter=6) | 300 | 11.5 | 11.8 | 426.7 | **+1.06x** |

---

## Notes

### Optimization history (db223e77 → 6650641d)
